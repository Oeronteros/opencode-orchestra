...
Автоматический режим overlay сохраняет прежнюю механику TUI, не пытаясь угадывать активную вкладку браузера.
