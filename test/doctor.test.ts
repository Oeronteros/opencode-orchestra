...
test("completionFor emits each shell family", () => {
  ...
  assert.match(bash, /install\|dashboard\|voice-tui\|voice-web\|web\|doctor\|mcp-smoke\|update\|completion/)
  for (const word of ["install", "dashboard", "voice-tui", "voice-web", "web", "doctor", "update", "completion", "--help"]) {
