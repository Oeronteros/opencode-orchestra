...
import { integratorBashPermissions, type RuntimeAgentConfig } from "./types.js"
...
export function createIntegratorAgent(config: OrchestraConfig, prompt?: string): RuntimeAgentConfig {
  ...
  return {
    ...
    permission: { "*": "deny", read: "allow", edit: "deny", glob: "allow", grep: "allow", list: "allow", lsp: "allow", bash: integratorBashPermissions(), task: "deny", external_directory: "deny" },
