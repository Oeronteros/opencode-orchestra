...
export function createMergeAgent(config: OrchestraConfig): RuntimeAgentConfig {
  ...
  return {
    ...
    mode: "subagent",
    prompt: "Merge the supplied specialist outputs only. Preserve file/URL evidence and provenance, deduplicate compatible findings, expose contradictions and uncertainty, and produce one actionable handoff. Do not add unsupported claims, edit files, or delegate.",
    hidden: true,
    temperature: 0.1,
