...
import { editorBashPermissions, type RuntimeAgentConfig } from "./types.js"

export function createEditorAgent(config: OrchestraConfig, prompt?: string): RuntimeAgentConfig {
  ...
  return {
    ...
    permission: { "*": "deny", read: "allow", edit: "allow", glob: "allow", grep: "allow", list: "allow", lsp: "allow", bash: editorBashPermissions(), "ast-grep_*": "allow", "ast_grep_*": "allow", task: "deny", external_directory: "deny" },
